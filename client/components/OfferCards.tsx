...
export default function OfferCard({ offer }: OfferCardProps) {
  return (
    <div className="border rounded-lg p-4 flex items-center justify-between mb-4 responsive styled">
      ...
      <Image src={`/fournisseur/${offer.fournisseur}.png`} alt={offer.fournisseur} width={80} height={80} />
      ...
      <div className="flex flex-col ml-4">
        ...
        <div className="flex items-center">
          <span className={`mr-2 ${offer.availability ? 'text-green-500' : 'text-red-500'}`}>
            {offer.availability ? 'Available' : 'Out of Stock'}
          </span>
          <img src="/icons/availability-icon.png" alt="Availability Icon" width={20} height={20} />
        </div>
      </div>

...
interface CategoryCardProps {
  ...
  title: string;
  description: string;
  onClick: () => void; // Add an onClick handler for interaction
}

const CategoryCard: React.FC<CategoryCardProps> = ({ imageSrc, title, description, onClick }) => {
  return (
    <div className="w-72 h-96 rounded-md overflow-hidden shadow-lg m-4 bg-white hover:shadow-2xl transition-shadow duration-300">
      {/* Image and Overlay */}
